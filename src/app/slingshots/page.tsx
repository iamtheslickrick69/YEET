...
export default function SlingshotsPage() {
  ...
  return (
    <main className="relative min-h-screen flex items-center justify-center overflow-hidden bg-black">
      ...
      {/* Main Content */}
      <section className="px-6 max-w-4xl relative" style={{ zIndex: 10 }}>
        <h1
        ...
        <p
          className={`${rajdhani.className} mt-6 text-white/90 text-center text-2xl md:text-3xl lg:text-4xl italic`}
        >
          {subheadingText}
        </p>
      </section>
